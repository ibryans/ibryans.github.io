...
function addParticipantes() {
    ...
    field_nome.className      = "input_field col l6 m6 s12";
    field_matricula.className = "input_field col L6 m6 s12";

    divider.className = "divider col s4 offset-s4 center-align hide-on-med-and-up";
    ...
    if (qtd_participantes < max_participantes) {
        ...
        div_12_colunas.append(field_nome,field_matricula,divider);
