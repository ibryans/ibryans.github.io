...
export default function Navbar() {
    ...
    return (
        ...
        <div className="fixed top-0 left-0 right-0 p-6 z-20">
            <header className={"flex items-center justify-between bg-transparent container mx-auto"}> 
                
                <button className="flex space-x-2 items-center group hover:bg-blu00 p-2 rounded-full transition">
                ...
                {/* Dark mode */}
                <svg onClick={toggleDarkMode} className="dark:hidden hover:animate-spin-finite hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" version="1.1" width="25" height="25" viewBox="0 0 256 256" xmlSpace="preserve">
                    <defs></defs>
                ...
                {/* Light mode */}
                <svg onClick={toggleDarkMode} className="hidden dark:block hover:animate-spin-finite hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="25" height="25" viewBox="0 0 256 256" xmlSpace="preserve">
                    <defs></defs>
                    <g style={{ strokeWidth: 0, strokeDasharray: 'none', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeMiterlimit: 10, fill: 'none', opacity: 1 }} transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)" >
